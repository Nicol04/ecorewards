        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="index.html" class="navbar-brand">
                    <h1 class="m-0 text-primary"><span class="text-dark">ECO</span>REWARDS</h1>
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="static/index.html" class="nav-item nav-link active">Inicio</a>
                        <a href="static/sobrenosotros.html" class="nav-item nav-link">Sobre nosotros</a>
                        <a href="static/comofunciona.html" class="nav-item nav-link">Cómo funciona?</a>
                        <a href="static/escuela.html" class="nav-item nav-link">Escuela</a>
                        <a href="static/contacto.html" class="nav-item nav-link" >Contacto</a>
                        <a href="static/recompensas.html" class="nav-item nav-link"><img src="static/img/recompensas.png" alt="Recompensas" class="boton-imagen"></a>
                    </div>
                </div>
            </nav>
        </div>
